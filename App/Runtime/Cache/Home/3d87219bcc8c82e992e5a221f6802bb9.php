...
<link href="/APP/Home/View/css/menu.css" rel="stylesheet" />
    ...
    <script src="/APP/Home/View/js/slide.js"></script>
<script src="/APP/Home/View/js/menu.js"></script>
</head>
...
<div id="topnavbar" style="display: block;">
  <div id="topnanv" style="width: 100%;">
    <div class="first"> <a href="#" target="_self">首页</a> </div>
    <div id="menu">
      <div content="att1" class="menuitem"> <a href="#">考勤</a></div>
      <div content="act" class="menuitem"><a href="#">活动</a></div>
      <div content="cla" class="menuitem"><a href="#">班级</a></div>
      <div content="user" class="menuitem"><a href="#">个人</a></div>
...
<img src="/APP/Home/View/image/good_on.png" class="icon" onclick=""/>
