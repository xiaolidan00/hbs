...
<?php } ?>
 <a class="title" href="./showActList">活动IDEAS</a>
 <a class="title active" href="./showClassList">班级联谊</a> 
...
<img src="<?php echo ($vo["photo"]); ?>" class="image1" onclick="location.href='/index.php/Home/Activity/showClassDetail?id=<?php echo ($vo["id"]); ?>'"/><br/>
<p align="center"><?php echo ($vo["claname"]); ?>
...
width="48" height="48" 
onclick="location.href='/index.php/Home/Activity/showInvite'" />
</body>
</html>