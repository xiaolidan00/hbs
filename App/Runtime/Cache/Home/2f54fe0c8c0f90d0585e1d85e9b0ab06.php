...
<?php } ?>
 ...
 <a class="title" href="./showClassList">班级联谊</a> 
  <a class="title active" href="./showRecList">活动回忆</a>
</div >
<!--end of body top-->
...
<img src="<?php echo ($vo["pic1"]); ?>" class="image1" onclick="location.href='/index.php/Home/Activity/showRecDetail?id=<?php echo ($vo["id"]); ?>'"/><br/>
<p><?php echo ($vo["title"]); ?>
...
width="48" height="48" 
onclick="location.href='/index.php/Home/Activity/showRecAdd'" /></body>
</html>